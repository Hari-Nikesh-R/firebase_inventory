...
import 'firebase_inventory_service_test.mocks.dart';
...
void main() {
  ...
  setUp(() {
    ...
    when(mockFirestore.collection('inventory')).thenReturn(mockInventoryCollection as CollectionReference<Map<String, dynamic>>);
    when(mockFirestore.collection('categories')).thenReturn(mockCategoryCollection as CollectionReference<Map<String, dynamic>>);
